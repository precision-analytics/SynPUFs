...
lipid_low<-readRDS('../dataset/lipid_low.RData')
...
##### Step 4: exclude individuals whose first lipid-lowering or niacin prescription was within 365 days from 2008-01-01:
```{r,message=F, warning=F}
...
rm(exclusion,exclusion2,beneficiary)
```


##### Step 5: exclude individuals with dialysis in previous year before cohort entry:
```{r,message=F, warning=F}
...
All covariates were ascertained before cohort entry
```{r,message=F, warning=F}
